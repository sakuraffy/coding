...
class TreeSolutionTest {
    ...
    void testSmallestFromLeaf() {
        final String result1 = treeSolutionUnderTest.smallestFromLeaf(TreeNode.create(Arrays.asList(0,1,2,3,4,3,4)));
        assertEquals("dba", result1);
        final String result2 = treeSolutionUnderTest.smallestFromLeaf(TreeNode.create(Arrays.asList(25,1,3,1,3,0,2)));
        assertEquals("adz", result2);
        final String result3 = treeSolutionUnderTest.smallestFromLeaf(TreeNode.create(Arrays.asList(2,2,1,null,1,0,null,0)));
        assertEquals("abc", result3);
    }

    @Test
    void testGenerateTree() {
        final List<TreeNode> result1 = treeSolutionUnderTest.generateTrees(3);
        assertEquals(Arrays.asList(Arrays.asList(1,null,2,null,3), Arrays.asList(1,null,3,2), Arrays.asList(2,1,3),
                Arrays.asList(3,1,null,null,2), Arrays.asList(3,2,null,1)).toString(), result1.toString());
        final List<TreeNode> result2 = treeSolutionUnderTest.generateTrees(1);
        assertEquals(Arrays.asList(Arrays.asList(1)).toString(), result2.toString());
    }

    @Test
    void testZigzagLevelOrder() {
        final List<List<Integer>> result1 = treeSolutionUnderTest.zigzagLevelOrder(TreeNode.create(Arrays.asList(3,9,20,null,null,15,7)));
        assertEquals(Arrays.asList(Arrays.asList(3), Arrays.asList(20, 9), Arrays.asList(15, 7)), result1);
        final List<List<Integer>> result2 = treeSolutionUnderTest.zigzagLevelOrder(TreeNode.create(Arrays.asList(1)));
        assertEquals(Arrays.asList(Arrays.asList(1)), result2);
        final List<List<Integer>> result3 = treeSolutionUnderTest.zigzagLevelOrder(TreeNode.create(Arrays.asList()));
        assertEquals(Arrays.asList(), result3);
    }

    @Test
    void testSortedListToBST() {
        final TreeNode result1 = treeSolutionUnderTest.sortedListToBST(ListNode.create(Arrays.asList(-10,-3,0,5,9)));
        assertEquals(Arrays.asList(0, -10, 5, null, -3, null, 9).toString(), result1.toString());
    }

    @Test
    void testMaxPathSum() {
        final int result1 = treeSolutionUnderTest.maxPathSum(TreeNode.create(Arrays.asList(1,2,3)));
        assertEquals(6, result1);
        final int result2 = treeSolutionUnderTest.maxPathSum(TreeNode.create(Arrays.asList(-10,9,20,null,null,15,7)));
        assertEquals(42, result2);
        final int result3 = treeSolutionUnderTest.maxPathSum(TreeNode.create(Arrays.asList(-3)));
        assertEquals(-3, result3);
        final int result4 = treeSolutionUnderTest.maxPathSum(TreeNode.create(Arrays.asList(2, -1)));
